...
class _$_InfoModel implements _InfoModel {
  const _$_InfoModel({required this.day, required this.place});
  ...
  @override
  String toString() {
    return 'InfoModel(day: $day, place: $place)';
  }
...
abstract class _InfoModel implements InfoModel {
  const factory _InfoModel(
      {required final String day, required final String place}) = _$_InfoModel;
